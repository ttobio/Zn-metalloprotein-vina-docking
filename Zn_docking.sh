...
python2 prepare_receptor4.py -r $1 -o protein.pdbqt -U nphs_lps_waters
...
python2 ../prepare_gpf4zn.py -l $ligand_clean.pdbqt -r protein_tz.pdbqt -o protein_tz.gpf -p spacing=$my_spacing -p npts=$x_dimension,$y_dimension,$z_dimension -p gridcenter=$x_center,$y_center,$z_center –p parameter_file=AD4Zn.dat
...
sleep 4
#cp ../vina_1.2.3_linux_x86_64 . "I alraady have vina added to the path"
vina --ligand $ligand_clean.pdbqt --maps protein_tz --scoring ad4 --exhaustiveness 32 --out $protein_clean\_$ligand_clean\_docked.pdbqt >$ligand_clean.log
